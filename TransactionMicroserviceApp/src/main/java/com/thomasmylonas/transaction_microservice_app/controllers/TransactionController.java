...
public class TransactionController {
    ...
    public ResponseEntity<ResponseSuccess> findTransactionById(@PathVariable(value = "id") Long transactionId) { // "http://localhost:8081/api/v1/transactions/{id}"
    ...
    @GetMapping
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<ResponseSuccess> findAllTransactions() { // "http://localhost:8081/api/v1/transactions"
    ...
    public ResponseEntity<ResponseSuccess> findAllTransactionsByPage(@RequestParam(value = "page", defaultValue = "0", required = false) int pageNumber,
                                                                     @RequestParam(value = "size", defaultValue = "10", required = false) int pageSize) { // "http://localhost:8081/api/v1/transactions?page=1&size=10"
    ...
    public ResponseEntity<ResponseSuccess> findAllTransactionsSorted(@RequestParam(value = "sort", defaultValue = "id", required = false) String sortBy,
                                                                     @RequestParam(value = "dir", defaultValue = "asc", required = false) String sortDir) { // "http://localhost:8081/api/v1/transactions?sort=field&dir=direction"
    ...
    public ResponseEntity<ResponseSuccess> findAllTransactionsByPageSorted(@RequestParam(value = "page", defaultValue = "0", required = false) int pageNumber,
                                                                           ...
                                                                           @RequestParam(value = "dir", defaultValue = "asc", required = false) String sortDir) { // "http://localhost:8081/api/v1/transactions?page=1&size=10&sort=field&dir=direction"
    ...
    public ResponseEntity<ResponseSuccess> saveTransaction(@RequestBody TransactionDto transactionDto) { // "http://localhost:8081/api/v1/transactions"
    ...
    @ResponseStatus(value = HttpStatus.CREATED)
    public ResponseEntity<ResponseSuccess> saveAllTransactions(@RequestBody List<TransactionDto> transactionDtos) { // "http://localhost:8081/api/v1/transactions/all"
    ...
    @PutMapping(path = {"/{id}"})
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<ResponseSuccess> updateTransaction(@RequestBody TransactionDto newTransactionDto, @PathVariable(value = "id") Long transactionId) { // "http://localhost:8081/api/v1/transactions/{id}"
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<ResponseSuccess> partialUpdateTransaction(@RequestBody Map<String, ?> fields, @PathVariable("id") Long transactionId) { // "http://localhost:8081/api/v1/transactions/{id}"
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public ResponseEntity<ResponseSuccess> deleteTransactionById(@PathVariable(value = "id") Long transactionId) { // "http://localhost:8081/api/v1/transactions/{id}"
